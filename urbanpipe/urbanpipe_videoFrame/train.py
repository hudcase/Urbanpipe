...
from helper.utils import train, test, setup_seed
import argparse
...
if __name__ == "__main__":
    ...
    parser.add_argument("--base_path", type=str, default="./dataset/tony_data_videoFrame", help="Base path of the dataset")
    ...
    parser.add_argument("--model_name", type=str, default="resnet18", help="Model name, default is a custom model")
